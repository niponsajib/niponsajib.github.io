...
author: Sajib Nipon
tags: [Intro, Biomedical Engineering]
image: /assets/images/circuit-board.svg
summary: Kicking off this blog with a quick tour of what I'm building, why biomedical engineering pulled me in, and what to expect here.
---

I've wanted a place to write down what I'm building for a while, so here it is — folded into a suitcase full of pokéballs, apparently. Fitting, since most of what I work on lives at the intersection of "this is a serious engineering problem" and "this should also be a little bit fun to use."
